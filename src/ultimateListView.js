...
export default class UltimateListView extends Component {
    ...
    paginationBtnView = (paginateCallback) => {
        if (this.props.paginationBtnView) {
            return this.props.paginationBtnView(paginateCallback);
        }

        return (
            <TouchableOpacity onPress={paginateCallback} style={styles.paginationBtn}>
                <Text style={styles.paginationBtnText}>{this.props.paginationBtnText}</Text>
            </TouchableOpacity>
        );
    };
    ...
    renderFooter = () => {
        if (this.state.paginationStatus === PaginationStatus.firstLoad) {
            ...
            return this.paginationBtnView(this.onPaginate);
        } else if (this.state.paginationStatus === PaginationStatus.fetching || this.state.paginationStatus === PaginationStatus.waiting && this.props.autoPagination === true) {
